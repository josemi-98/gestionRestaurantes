...
class UserController extends AbstractController
{
    ...
    public function verReservasUsuario(PaginatorInterface $paginator, Request $request, RestauranteRepository $restauranteRepository): Response
    {
        ...
        $reservasCollection = $usuario->getReservas();
        ...
        if ($nombreRestaurante) {
            $reservasCollection = $reservasCollection->filter(function ($reserva) use ($nombreRestaurante) {
        ...
        $reservas = new ArrayCollection($reservasCollection->toArray());

        // Invertir el orden de las reservas y los idRestaurantes
