...
class getLoginControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.7CWlFZt'] ?? $container->load('get_ServiceLocator_7CWlFZtService'))->withContext('App\\Controller\\LoginController', $container));
