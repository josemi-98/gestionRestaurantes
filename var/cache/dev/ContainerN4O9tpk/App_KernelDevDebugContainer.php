...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\MesaCrudController' => 'getMesaCrudControllerService',
            'App\\Controller\\Admin\\OpinionCrudController' => 'getOpinionCrudControllerService',
            'App\\Controller\\Admin\\ReservaCrudController' => 'getReservaCrudControllerService',
            'App\\Controller\\Admin\\RestauranteCrudController' => 'getRestauranteCrudControllerService',
            ...
            'App\\Controller\\MesaController' => 'getMesaControllerService',
            ...
            'App\\Controller\\Restaurante\\RestauranteController' => 'getRestauranteController2Service',
            'App\\Controller\\Usuario\\UserController' => 'getUserControllerService',
            'App\\Service\\Pdf' => 'getPdfService',
            ...
            'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.restaurante' => 'getSmartUniqueNamer_RestauranteService',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('OKOKN9Bmsh', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UjTFh6Ju8n', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('N4Tpp6SLbd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4qT0ll4IxH', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory($this->parameters['doctrine.dbal.connection_factory.types']))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'vich_uploader.listener.clean.restaurante' => ['privates', 'vich_uploader.listener.clean.restaurante', 'getVichUploader_Listener_Clean_RestauranteService', true],
            'vich_uploader.listener.remove.restaurante' => ['privates', 'vich_uploader.listener.remove.restaurante', 'getVichUploader_Listener_Remove_RestauranteService', true],
            'vich_uploader.listener.upload.restaurante' => ['privates', 'vich_uploader.listener.upload.restaurante', 'getVichUploader_Listener_Upload_RestauranteService', true],
        ], [
            'doctrine.orm.default_listeners.attach_entity_listeners' => '?',
            'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber' => '?',
            'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber' => '?',
            'vich_uploader.listener.clean.restaurante' => '?',
            'vich_uploader.listener.remove.restaurante' => '?',
            'vich_uploader.listener.upload.restaurante' => '?',
        ]), [0 => 'vich_uploader.listener.clean.restaurante', 1 => 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_subscriber', 2 => 'doctrine.orm.listeners.doctrine_token_provider_schema_subscriber', 3 => 'vich_uploader.listener.remove.restaurante', 4 => 'vich_uploader.listener.upload.restaurante', 5 => [0 => [0 => 'loadClassMetadata'], 1 => 'doctrine.orm.default_listeners.attach_entity_listeners']]), []);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\OpinionRepository' => ['privates', 'App\\Repository\\OpinionRepository', 'getOpinionRepositoryService', true],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('L9ihXxpMKw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6zBp1C4wFO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('K45FY5WxtP', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EKP6EqYOpB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cWW7NB9y5g', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'vich_uploader.mappings' => [
                'restaurante' => [
                    'uri_prefix' => '/images/restaurante',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/images/restaurante'),
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\SmartUniqueNamer.restaurante',
                        'options' => [
