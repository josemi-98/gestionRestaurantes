 ...
 */
class getVichUploader_Listener_Clean_RestauranteService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.clean.restaurante' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.clean.restaurante'])) {
            return $container->privates['vich_uploader.listener.clean.restaurante'];
        }

        return $container->privates['vich_uploader.listener.clean.restaurante'] = new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('restaurante', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
