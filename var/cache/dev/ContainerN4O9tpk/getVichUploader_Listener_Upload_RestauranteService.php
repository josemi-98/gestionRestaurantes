 ...
 */
class getVichUploader_Listener_Upload_RestauranteService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.restaurante' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.restaurante'])) {
            return $container->privates['vich_uploader.listener.upload.restaurante'];
        }

        return $container->privates['vich_uploader.listener.upload.restaurante'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('restaurante', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
